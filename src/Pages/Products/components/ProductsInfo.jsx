...
const ProductsInfo = () => {
    ...
    return (
        <>
            <div className="bg-white flex flex-col lg:items-start lg:justify-start justify-center items-center px-[20px] gap-[20px]">
                <div className="w-[100%] md:w-3/4 flex flex-col gap-[20px] p-2">
                    ...
                    <div className='flex items-start flex-col gap-[30px] mt-[10px]'>
                        <div className='text-[14px] flex gap-[30px] items-center'><strong className='text-[#666]'>SKU:</strong> <span className='text-[#010101] !font-thin'>12345</span></div>
                        <div className='text-[14px] flex gap-[30px] items-center'><strong className='text-[#666]'>Categories:</strong> <span className='text-[#010101] !font-thin'><Link to="#" className='hover:text-[#e55472] !font-thin'>Flower</Link></span></div>
                        <div className='text-[14px] flex gap-[30px] items-center'><strong className='text-[#666]'>Tags:</strong> <span className='text-[#010101] !font-thin'> <Link to="#" className='hover:text-[#e55472] !font-thin'>Love </Link> , <Link to="#" className='hover:text-[#e55472] !font-thin'>Flower</Link> , <Link to="#" className='hover:text-[#e55472] !font-thin'>Heart</Link></span></div>
                    </div>
                </div>
            </div>
        </>
