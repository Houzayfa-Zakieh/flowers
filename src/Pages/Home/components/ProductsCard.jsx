...
const ProductsCard = (props) => {
    return (
        <>
            <div className="w-[288px] productsCard relative">
                <div>
                    <div>
                        <Link to="/">
                        ...
                        <div>
                            <ul className="cardButtons opacity-0 absolute bottom-0 transform translate-y-[-35px] flex w-full flex-grow-1 flex-shrink-0 flex-basis-auto -webkit-box">
                                <li className=" bg-[#666] hover:bg-[#E55472] w-[74px] flex items-center justify-center text-center cursor-pointer h-[50px]">
                                ...
                                <li className="bg-[#666] hover:bg-[#E55472] w-[74px] text-center h-[50px] flex items-center justify-center cursor-pointer">
